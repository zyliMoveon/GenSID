...
def TransformAug(mode='Weak'):
    if mode=='Weak':
        return mtransforms.OneOf(
                ...
                # randtranslate
                mtransforms.RandAffine(prob=1.0,translate_range=(10, 0),padding_mode='border'),
                mtransforms.RandAffine(prob=1.0,translate_range=(0, 10),padding_mode='border'),
...
class RetinaDataset(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        self.datapath='/data/zyli/Datasets/Eyepacs'
        self.h_pairs= pickle.load(open(self.datapath+'/trainLabels/label_0_folds.pkl', 'rb'))
        self.uh_pairs= pickle.load(open(self.datapath+'/trainLabels/label_1_folds.pkl', 'rb'))
