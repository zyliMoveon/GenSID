...
class GeneratorBlock(nn.Module):
    def __init__(self, latent_dim, input_channels, filters, upsample=True, upsample_rgb=True, rgba=False, cond_dim=512):
        super().__init__()
...
class StyleGAN2(nn.Module):
    def __init__(self, image_size, latent_dim=4096, fmap_max=512, style_depth=8, network_capacity=16, transparent=False,
