...
#basics
fid_dir = "/home/zyli/Project/Project2/3d_stylegan2_pytorch/3D_StyleGAN_Circle_of_Willis-main/fid"
...
eval_dir = "/home/zyli/Project/Project2/3d_stylegan2_pytorch/3D_StyleGAN_Circle_of_Willis-main/EVALUATION"  # adjust the path

# Pretrained MedicalNet path
pretrained_model_path = "/home/zyli/Project/Project2/3d_stylegan2_pytorch/3D_StyleGAN_Circle_of_Willis-main/MedicalNet/resnet_10_23dataset.pth"  # adjust the path
...
fid_dir_pro = os.path.join(fid_dir, project_name)
data_dir_real_3D = os.path.join(fid_dir_pro, "real_3d")
data_dir_gen_3D = os.path.join(fid_dir_pro, "fake_3d")
